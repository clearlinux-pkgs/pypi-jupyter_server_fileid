...
%prep
%setup -q -n jupyter_server_fileid-0.9.1
cd %{_builddir}/jupyter_server_fileid-0.9.1
pushd ..
cp -a jupyter_server_fileid-0.9.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1703116376
